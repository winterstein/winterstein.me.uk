...
#####
PROJECT_NAME='winterstein.me' #This name will be used to create/or/refer-to the directory of the project in /home/winterwell/
GIT_REPO_URL='git.winterwell.com:/winterstein.me' #
